    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tasksContainer}>
        ...
        {tasks.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No todo tasks</Text>
            <Text style={styles.emptySubtext}>Add some tasks from the calendar</Text>
          </View>
        ) : (
            ...
            {tasks.map((task) => (
              <View key={task.id} style={styles.taskItemWrapper}>
                <View style={styles.taskItem}>
                  ...
                  <TouchableOpacity 
                    style={[styles.getStartedButton, { backgroundColor: task.color }]}
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.activeNavItem} >
          ...
          <Text style={[styles.navText, styles.activeNavText]}>To Do</Text>
        </TouchableOpacity>
